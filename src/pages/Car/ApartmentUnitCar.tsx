...
import InboxMenuList from '../../components/Inbox/InboxMenuList.tsx';
import DropdownDefault from '../../components/Dropdowns/DropdownDefault.tsx';
import InboxList from '../../components/Inbox/InboxList.tsx';
      ...
      <div className="sm:h-[calc(100vh-174px)] h-[calc(100vh-186px)] overflow-hidden">
        <div
          ...
          <div className="lg:w-4/5 flex h-full flex-col border-l border-stroke dark:border-strokedark">
            {/* <!-- ====== Inbox List Start --> */}
            <div
              className="lg:pr-7.5 flex flex-col-reverse justify-between gap-6 py-4.5 pl-4 pr-4 sm:flex-row lg:pl-10">
              <div className="flex items-center gap-4">
                ...
                >
                  <div className="relative">
                    ...
                    />
                    <div
                      className="box flex h-5 w-5 items-center justify-center rounded-[3px] border-[.5px] border-stroke bg-gray-2 text-white dark:border-strokedark dark:bg-boxdark-2">
